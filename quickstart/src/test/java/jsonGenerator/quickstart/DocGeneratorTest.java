...
public class DocGeneratorTest {
	...
	public void createFileTest() throws IOException {
		...
		File outputText = new File("resources/test.txt");
		File outputJSON = new File("resources/test.json");
		File outputHTML = new File("resources/test.html");
		
		File JUnitTestText = new File("resources/JUnitTest.txt");
		File JUnitTestJSON = new File("resources/JUnitTest.json");
		File JUnitTestHTML = new File("resources/JUnitTest.html");
